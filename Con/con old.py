...
def main():
	...
	if con == "1" or con == "01":
		...
		infogathering = raw_input(green + "Con ==> ")
		...
		print "    [00] Back to main menu\n"
		stresstest = raw_input(Fore.YELLOW +"Con ==> ")
