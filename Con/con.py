...
def main():
	banner()
	print " \033[33m  [01] ==> Information Gathering"
	print " \033[33m  [02] ==> Vulnerability Scanner"
	print " \033[33m  [03] ==> Stress Testing"
	print " \033[33m  [04] ==> Password Attacks"
	print " \033[33m  [05] ==> Web Hacking"
	print " \033[33m  [06] ==> Exploitation Tools"
	print " \033[33m  [07] ==> Sniffing & Spoofing"
	print " \033[33m  [08] ==> Some Tool"
        print " \033[33m  [09] ==> Wifi Hacking Tools"
        print " \033[33m  [10] ==> My Own Tools"
        print " \033[33m  [11] ==>Programming Tools(comming soon)\n"
	print " \033[33m  [11] Exit the Con\n"
	con = raw_input(red+"""┌─[\033[32;1mroot\033[31;1m@\033[33mFahadAkash]─[Contool]
└──╼ \033[32;1m#"""+green)
	
	if con == "1" or con == "01":
                os.system('figlet -f mini ............Information Gathering..............')
		print "\n    [01] Nmap"
		print "    [02] Red Hawk"
		print "    [03] D-Tect"
		print "    [04] sqlmap"
		...
		infogathering = raw_input(red+"""┌─[root@FahadAkash]─[Contool]
└──╼ #"""+green)
	...
	elif con == "2" or con == "02":
                os.system('figlet ...........Vulnerability Scanner..............')
		print "\n    [01] Nmap"
		...
		print "    [23] OWScan\n"
		print "    [00] Back to main menu\n"
		vulnscan = raw_input(red+"""┌─[root@FahadAkash]─[Contool]
└──╼ #"""+green)
	...
	elif con == "3" or con == "03":
                os.system('figlet -f mini .................Stress Testing.................')
		print "\n    [01] Torshammer"
		print "    [02] Slowloris"
		...
		print "    [00] Back to main menu\n"
		stresstest = raw_input(red+"""┌─[root@FahadAkash]─[Contool]
└──╼ #"""+green)
		...
		print "    [14] Hashzer\n"
		print "    [00] Back to main menu\n"
		passtak = raw_input(red+"""┌─[root@FahadAkash]─[Contool]
└──╼ #"""+green)
	...
	elif con == "5" or con == "05":
                os.system('figlet -f mini .............. Web Hacking...............')
		print "\n    [01] sqlmap"
		print "    [02] Webdav"
		print "    [03] xGans"
		...
		print "    [16] OWScan\n"
		print "    [00] Back to main menu\n"
		webhack = raw_input(red+"""┌─[root@FahadAkash]─[Contool]
└──╼ #"""+green)
		...
		print "    [11] TXTool\n"
		print "    [00] Back to main menu\n"
		exploitool = raw_input(red+"""┌─[root@FahadAkash]─[Contool]
└──╼ #"""+green)
		...
		if exploitool == "01" or exploitool == "1":
			...
			timeout(2)
			restart_program()
	elif con == "7" or con == "07":
                os.system('figlet -f mini .........Sniffing and Spoofing...........')
		print "\n    [01] KnockMail"
		...
		print "    [07] SpazSMS\n"
		print "    [00] Back to main menu\n"
		sspoof = raw_input(red+"""┌─[root@FahadAkash]─[Contool]
└──╼ #"""+green)
	...
	elif con == "8" or con == "08":
                os.system('figlet  ..........Termux Users..........')
		print "\n    [01] SpiderBot"
		print "    [02] Ngrok"
		print "    [03] Sudo"
		print "    [04] Ubuntu"
		...
		print "    [10] PassGen\n"
		print "    [00] Back to main menu\n"
		moretool = raw_input(red+"""┌─[root@FahadAkash]─[Contool]
└──╼ #"""+green)
		...
		print ("ok")
		os.system("figlet -f mini .......WIfiHacking")
		print("          {1}==>Airgeddon")
		print("          {2}==>Fluxion")
		print("          {3}==>Wifite")
		print("          {4}==>Wifipumking")
...
└──╼ #"""+green)
		...
		if sspoof == "5":
			mitmap()
               ...
               os.system('figlet -f mini .........My Own Tool')
               print ("     {1}==>Easy-Kali{New}")
               print ("     {00} ==> Go to Main Menu:\n")
               ezz = raw_input(red+"""┌─[root@FahadAkash]─[Contool]
└──╼ #"""+green)
