...
def Airgeddon():
	os.system('git clone https://github.com/v1s1t0r1sh3r3/airgeddon')
	os.system('mv airgeddon ~')
...
def Wifipumking():
	os.system('git clone https://github.com/P0cL4bs/WiFi-Pumpkin')
	os.system('mv WiFi-Pumpkin ~')
	backtomenu_option()

def mitmap():
	os.system('git clone https://github.com/xdavidhu/mitmAP')
	os.system('mv mitmAP')
	backtomenu_option()